...
  // Ahora useAuth nos da acceso a las funciones y tipos actualizados
  const { login, setUser } = useAuth(); 
  const [correo, setCorreo] = useState("");
  const [contrasena, setContrasena] = useState("");
  const [loading, setLoading] = useState(false);

  //MODIFICACIÓN: Redirección basada en el rol del usuario autenticado
...
    setLoading(true);
    // La función login del AuthContext ahora guarda el usuario con su 'rol'
